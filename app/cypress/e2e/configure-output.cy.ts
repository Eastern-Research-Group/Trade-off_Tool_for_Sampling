describe('Configure output tests', () => {
  ...
  it('Verify texts', () => {
    ...
    cy.findByText(
      'A subset of TOTS output will be published by default. Click Add User-Defined Attributes to optionally add additional attributes to use with field data collection apps.',
    ).should('exist');
    cy.findByText('Add User-Defined Attributes')
      .should('exist')
      .click({ force: true });
  ...
  it('Verify add new attribute', () => {
    ...
    cy.findByText('Add User-Defined Attributes')
      .should('exist')
      .click({ force: true });
    cy.findByRole('button', { name: 'Add New Attribute' })
      .should('exist')
      .click();
    ...
    cy.findByRole('dialog')
      .contains('a', 'working with fields')
    ...
    cy.findByRole('dialog')
      .contains('a', 'EXIT')
      .should('have.attr', 'href')
      .and('equal', 'https://www.epa.gov/home/exit-epa');
